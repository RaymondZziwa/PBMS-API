export const requestUserAccessKeyEmail = (
  ...
  return `
    ...
    We received a request for an access key inorder to access your account at Prof-bioresearch Management System. To help you regain access to your account, we have generated a unique access key for you.
